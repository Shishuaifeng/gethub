 ...
 * 多线程下载步骤：
 ...
 3.计算分配几个线程去下载服务器上的资源 每条线程下载量(计算block每条线程的下载量)。
 4.开启线程，每一个线程下载对应的文件。
        ...
        new Thread(){
            public void run() {
                try {
                    ...
                    //http://d.988wan.com/zft/qmzft32_988wan_01.apk
                   ...
                   //http://mirror.aarnet.edu.au/pub/TED-talks/911Mothers_2010W-480p.mp4
                    String uri = "http://mirror.aarnet.edu.au/pub/TED-talks/911Mothers_2010W-480p.mp4";
                   //从头信息里获取文件大小 不获取内容
